...
import (
	...
	"io/ioutil"
	"path/filepath"
	libp2psatnet "satnet-libp2p/libp2psatnet"
	"strings"

	//"chainmaker.org/chainmaker/net-libp2p/libp2psatnet"
	"chainmaker.org/chainmaker/protocol/v2"
)

// NetOption is a function apply options to net instance.
type NetOption func(ln *libp2psatnet.LibP2pNet) error
...
func WithReadySignalC(signalC chan struct{}) NetOption {
	return func(ln *libp2psatnet.LibP2pNet) error {
...
func newNet(netLogger protocol.Logger, opts ...NetOption) (protocol.Net, error) {
	localNet, err := libp2psatnet.NewLibP2pNet(netLogger)
	if err != nil {
		return nil, err
	}
...
// Apply options.
func Apply(ln *libp2psatnet.LibP2pNet, opts ...NetOption) error {
