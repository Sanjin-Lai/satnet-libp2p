...
module github.com/Sanjin-Lai/satnet-libp2p
...
replace chainmaker.org/chainmaker/libp2p-pubsub v1.3.1 => chainmaker.org/chainmaker/libp2p-pubsub v1.1.3

replace chainmaker.org/chainmaker/net-common v1.3.1 => chainmaker.org/chainmaker/net-common v1.2.3
